package by.mozolevskij.pharmacy.example.keyboard_shortcuts;
...
public class ExampleClass {
    ...
    public static void main(String[] args) {
        int goodCount1 = 5; /** Ctrl + W - выделение строки, Ctrl + Shift + W - отмена выделения*/
        int goodCount2 = 8; /** Ctrl + вверх/вниз - пркрутка, Ctrl + вправо/влево - перемещение между словами*/
