...
//Рассмотрим следующий пример. Есть пять остановок. На первых четырех
// из них могут стоять пассажиры и ждать автобуса. Автобус выезжает из
// парка и останавливается на каждой остановке на некоторое время. После
// конечной остановки автобус едет в парк. Нам нужно забрать пассажиров
// и высадить их на нужных остановках.
public class PhaserExample {

    /**Как и CyclicBarrier реализация шаблона Barrier,
