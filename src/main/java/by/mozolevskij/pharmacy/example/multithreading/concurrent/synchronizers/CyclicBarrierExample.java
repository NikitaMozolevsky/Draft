...
//альтернатива методу join() - который ожидает, пока завершится поток
//для которыго вызывается join()

import java.util.concurrent.CyclicBarrier;

//Рассмотрим следующий пример. Существует паромная переправа.
// Паром может переправлять одновременно по три автомобиля.
// Чтобы не гонять паром лишний раз, нужно отправлять его, когда
// у переправы соберется минимум три автомобиля.
